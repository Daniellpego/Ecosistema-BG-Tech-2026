...
const services = [
  {
    ...
    title: "Sites",
    description: "Sites institucionais, landing pages e e-commerce que transformam visitantes em clientes.",
  },
  {
    slug: "apps",
    icon: (
    ...
    title: "Apps",
    description: "Aplicativos iOS e Android para sua equipe, seus clientes ou sua operação interna.",
  },
  {
    slug: "sistemas",
    icon: (
  ...
  },
  {
    ...
    title: "Automações + IA",
    description: "Atendimento automático no WhatsApp, agendamento inteligente e agentes de IA que rodam por você.",
  },
];
...
export default function ServicosPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="pt-14 pb-12 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold text-text mb-4">
            Nossos Serviços
          </h1>
          <p className="text-text-muted text-base sm:text-lg leading-relaxed mb-5">
            Tecnologia sob medida para sua empresa — do site ao sistema, com IA aplicada.
          </p>
          <span className="inline-flex items-center gap-1.5 text-xs font-medium text-text-muted border border-card-border rounded-pill px-3 py-1">
      ...
      <section className="pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto bg-[#0A1B3D] rounded-card p-8 sm:p-10 text-center">
          ...
          <p className="text-white/60 text-sm sm:text-base mb-8 leading-relaxed">
            Conta o que sua empresa precisa. A gente desenha a solução.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white text-[#0A1B3D] text-sm font-semibold px-8 py-3.5 rounded-pill hover:bg-white/90 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white/10 text-white text-sm font-semibold px-6 py-3.5 rounded-pill hover:bg-white/15 transition-colors"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
