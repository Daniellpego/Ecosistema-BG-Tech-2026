...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan/50 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'gradient-cyan text-bg-navy hover:opacity-90 rounded-[12px]',
        secondary: 'bg-bg-card text-text-primary hover:bg-bg-hover rounded-[12px] border border-brand-blue-deep/50',
        ...
        outline: 'text-text-primary hover:bg-bg-hover rounded-[12px] border border-brand-blue-deep/50',
      },
      size: {
