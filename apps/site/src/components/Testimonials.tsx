        ...
        >
          ...
          >
            <div>
              ...
              <p className="text-sm text-text-muted">Clínica de fisioterapia substituiu o atendimento manual por uma IA que responde 24 horas via WhatsApp, qualifica leads e organiza tudo em um dashboard com avisos de agendamento e consultas.</p>
            </div>
            <div className="pt-4 mt-4 border-t border-card-border flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-primary/10 border border-card-border flex-shrink-0 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <div>
              ...
              <p className="text-sm text-text-muted">Terapeuta com agenda desorganizada ganhou um sistema completo: banco de dados de pacientes, agendamento automático com avisos inteligentes e reagendamento automático em feriados.</p>
            </div>
            <div className="pt-4 mt-4 border-t border-card-border flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-primary/10 border border-card-border flex-shrink-0 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
